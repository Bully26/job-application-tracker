<template>
    <div class="text-black z-10 bg-amber-200 w-[100%] h-full p-5">
        <div class=" bg-slate-200 w-[100%] h-full">
            <div class="p-10 text-4xl border-b-10">
                Your Applications
            </div>
            <div>
                <div class="flex justify-between text-2xl my-2 p-2">
                    <div class="bg-white rounded-4xl p-2">
                ...
                <div id="tableHeader" class="flex gap-1 w-[100%] bg-white justify-around border-b-2">
                    <div v-for="title in applicationFields" :style="{ width: getWidth(title.name) }" class="text-xl p-3 bg-slate-200 rounded-2xl mx-4 my-1 overflow-auto transform -translate-x-3">
                        <Icon :name="title.icon" class="align-middle" /> {{title.name}}
                    </div>
                </div>
                <div id="table data" class="overflow-auto h-200 text-xl">
                    <div v-for="data in applicationsData" class="flex gap-1 w-[100%] bg-white justify-around border-b-2 ">
                        <div class="w-[15%] content-center">
                            {{data.Company}}
                        </div>
                        <div class="w-[15%] content-center ">
                            <div class="m-4 ml-0 p-2 rounded-2xl w-[70% " :class="stage_color(data.Stage)">
                                {{data.Stage}}
                            </div>
                        </div>
