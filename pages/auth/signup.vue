            ...
            <div class="sm:max-w-md lg:max-w-lg">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mb-8">
                        Join thousands of professionals who are using JobTracker to organize their job search and land their dream positions faster.
                    </p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    ...
                    <p class="text-gray-700 italic">
                        "JobTracker helped me organize my applications and track my progress. I landed my dream job within 3 months!"
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24 bg-white">
            <div class="sm:max-w-md lg:max-w-lg mx-auto w-full">
                ...
                <div class="flex items-center space-x-2 mb-8">
                  ...
                  <path fill-rule="evenodd" d="M4 5a2 2 0 012-2v1a1 1 0 001 1h6a1 1 0 001-1V3a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm2.5 7a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm2.45.855a2.5 2.5 0 10-3.9 0 .5.5 0 00.4.8h3.1a.5.5 0 00.4-.8z" clip-rule="evenodd"/>
                </svg>
                    </div>
                ...
                <form @submit.prevent="signup" class="space-y-6">
                    ...
                    First name
                            ...
                            <input id="firstName" v-model="form.firstName" name="firstName" type="text" placeholder="John" class="mt-1 input-field" />
                    ...
                    Last name
                            ...
                            <input id="lastName" v-model="form.lastName" name="lastName" type="text" placeholder="Doe" class="mt-1 input-field" />
                  ...
                  Email address
                        ...
                        <input id="email" v-model="form.email" name="email" type="email" autocomplete="email" placeholder="john.doe@example.com" class="mt-1 input-field" />
                  ...
                  Password
                        ...
                        <div class="mt-1 relative">
                            <input id="password" v-model="form.password" name="password" :type="showPassword ? 'text' : 'password'" placeholder="Create a strong password" class="input-field pr-10" />
                    ...
                    <div class="flex items-start">
                        <input id="terms" v-model="form.acceptTerms" name="terms" type="checkbox" class="h-4 w-4 text-primary-600 border-gray-300 rounded focus:ring-primary-500 mt-1" />
              ...
              <div class="font-medium text-blue-500 hover:text-blue-600 text-center text-2xl" v-if="signupSuccess">
                        SignUp Successfully
                    </div>
                </form>
