  ...
  <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
    <div class="overflow-x-auto overflow-y-scroll">
      <table class="w-full">
        ...
        <tbody class="drag-area w-full">
          <ApplicationRow  v-for="element in searchedlist" :key="element.id" :application="element" v-on:edit="showmod" />
        </tbody>
      </table>
    </div>
...
const searchedlist=computed(()=>{
  ...
  return applications.value.filter(obj =>
